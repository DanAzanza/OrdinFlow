        ...
        if llm_extractor is not None:
            try:
                system_prompt = (
                    ...
                    "- FOR_EACH_DOCUMENT: {'action_type': 'FOR_EACH_DOCUMENT', 'document_types': ['Fußscan', 'Rezept'], 'actions': [...]}\n"
                    "- BRANCH / IF_CONDITION: {'action_type': 'BRANCH', 'condition': \"{category} == 'Fußscan'\", 'then_actions': [...], 'else_actions': [...]}\n"
                    "- FOR_EACH: {'action_type': 'FOR_EACH', 'collection_var': 'items', 'item_var': 'item', 'actions': [...]}\n"
                    "- WHILE_LOOP: {'action_type': 'WHILE_LOOP', 'condition': \"{status} == 'pending'\", 'max_iterations': 20, 'actions': [...]}\n"
